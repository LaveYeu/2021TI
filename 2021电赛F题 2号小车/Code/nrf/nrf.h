...
#define  NRF_GPIO_CLK             RCC_APB2Periph_GPIOB
#define  NRF_CE_GPIO_PORT		  GPIOB
#define  NRF_CE_GPIO_PIN		  GPIO_Pin_11
#define  NRF_IRQ_GPIO_PORT		  GPIOB
#define  NRF_IRQ_GPIO_PIN		  GPIO_Pin_10

#define  NRF_CE_SET(a)     if(a) GPIO_SetBits(NRF_CE_GPIO_PORT, NRF_CE_GPIO_PIN);\
                           else  GPIO_ResetBits(NRF_CE_GPIO_PORT, NRF_CE_GPIO_PIN)

#define  NRF_IRQ_STATUS()  ((NRF_IRQ_GPIO_PORT->IDR & (uint32_t)NRF_IRQ_GPIO_PIN) != NRF_IRQ_GPIO_PIN) ? 0 : 1	//IRQ??
