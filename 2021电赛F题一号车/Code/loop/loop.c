...
//    LED1_TOGGLE;
	...
	Status = vl53l0x_start_single_test(&vl53l0x_dev,&vl53l0x_data,buf);//执行一次测量
			if(Status==VL53L0X_ERROR_NONE)
			{
				...
				else if(Distance_data>100&&Distance_data<115)
				{
					Solve = 3;
				}
				else if(Distance_data>115&&Distance_data<130)
				{
					Solve = 4;
				}
